    ...
    return (
        <div className={`container ${fadeIn ? "fade-in" : ""}`}>
            ...
            <div className="text fade-in-up" style={{ animationDelay: '1.7s' }}>
                ...
                <p>
                At the center of all this is a mindset I carry with me: take ownership, learn fast, support the mission, and elevate the people around you. Whether I'm solving problems at the keyboard or helping a team cross the finish line, I'm always looking for the most effective way to get the job done—and to do it well.</p>
                </p>
            </div>
    );
}
